...
class BPSDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, f'{self.train_dir}\{self.train_csv}', self.train_dir)

        # call the save_tiffs_local_from_s3 function to download tiffs from the
        # val_csv file.        
        save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, f'{self.val_dir}\{self.val_csv}', self.val_dir)
        ...
        if self.test_csv is not None:
            ...
            save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, f'{self.test_dir}\{self.test_csv}', self.test_dir)  
    ...
    def val_dataloader(self) -> EVAL_DATALOADERS:
        ...
        val_dataloader = DataLoader(
            ...
            batch_size=self.batch_size,
            shuffle=True, # IDK IF WE SHUFFLE VALIDATION DATA, GOOGLE SAYS IT DOESN'T MATTER - sammy
